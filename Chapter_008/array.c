...
int main(void)
{
    ...
    {
        int sales[] = {192, 280, 3720, 430, 440};
        for (int i = 0; i < 5; i++)
            printf("%d ", sales[i]);
        puts("");
    }
    ...
    {
        // int sales[] = {[2] = 370, 460, 550, [0] = 190, 280};

        // array.c:122:59: sorry, unimplemented: non-trivial designated initializers not supported
        // 122 |         int sales[] = {[2] = 370, 460, 550, [0] = 190, 280};
        //     |                                                           ^
        // for (int i = 0; i < sizeof sales / sizeof sales[0]; i++)
        // printf("%d ", sales[i]);
        // puts("");
